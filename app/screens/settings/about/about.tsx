        ...
        <SettingContainer testID='about'>
            ...
            <View style={styles.infoContainer}>
                ...
                {!MATTERMOST_BUNDLE_IDS.includes(applicationId || '') &&
                    <FormattedText
                        defaultMessage='{site} is powered by TeamUP'
                ...
                /> */}
                {/* <FormattedText
                    defaultMessage='Copyright 2015-{currentYear} TeamUP, Inc. All rights reserved'
                ...
                {/* <View style={styles.noticeContainer}>
                    <FormattedText
                        ...
                        defaultMessage='TeamUP is made possible by the open source software used in our {platform} and {mobile}.'
                        style={styles.footerText}
                        values={{
                            platform: (
                                <FormattedText
