...
const Settings = ({componentId, helpLink, showHelp, siteName}: SettingsProps) => {
    ...
    const goToAbout = preventDoubleTap(() => {
        ...
        const title = intl.formatMessage({id: 'settings.about', defaultMessage: 'About TeamUp'}, {appTitle: "TeamUp"});
        //serverName
    ...
    return (
        <SettingContainer testID='settings'>
            ...
            <SettingItem
                ...
                label={intl.formatMessage({id: 'settings.about', defaultMessage: 'About TeamUp'}, {appTitle: "TeamUp"})}
                onPress={goToAbout}
                optionName='about'
